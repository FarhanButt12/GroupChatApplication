...
export const AuthForm: React.FC<AuthFormProps> = ({
  ...
  return (
    <div className="h-screen w-screen bg-slate-950 flex overflow-hidden select-none">
      {/* FULL-PAGE SPLIT GRID (ATTACHED SEAMLESS FULL COVERAGE) */}
      <div className="w-full h-full grid grid-cols-1 lg:grid-cols-12 overflow-hidden">
        ...
        <div className="hidden lg:flex lg:col-span-7 bg-gradient-to-br from-slate-900 via-slate-950 to-slate-950 p-10 lg:p-16 flex-col justify-between relative overflow-hidden">
          ...
          <div className="max-w-xl space-y-8 relative z-10 py-4">
        ...
        {/* RIGHT COLUMN: Full-Bleed Attached Auth Section */}
        <div className="col-span-1 lg:col-span-5 bg-slate-950/95 border-l border-slate-800/80 p-6 sm:p-10 lg:p-14 flex flex-col justify-between h-full overflow-y-auto relative z-10">
          ...
          <div className="w-full">
            ...
            <div className="space-y-1 pt-2 lg:pt-6">
              <h3 className="text-2xl font-black text-white tracking-tight">
                {mode === 'login' ? 'Sign In Workspace' : 'Create Account'}
              </h3>
              <p className="text-xs text-slate-400 font-medium">
                {mode === 'login'
                  ? 'Enter your account details to access your workspace dashboard.'
          ...
          <div className="w-full max-w-md mx-auto space-y-6 py-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {mode === 'register' && (
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-slate-900/90 border border-slate-800 rounded-xl text-xs text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/50 transition-all"
                  />
                </div>
              )}
              ...
              <button
                ...
                className="w-full py-3.5 gradient-btn text-white font-black rounded-xl text-xs disabled:opacity-40 transition-all shadow-xl mt-2 flex justify-center items-center gap-2 hover:scale-[1.01]"
              >
                {loading ? (
                  <>
          ...
          <div className="text-center text-[11px] text-slate-500 pb-2">
            Protected by Nexus Enterprise Auth & JWT Security
          </div>
        </div>
